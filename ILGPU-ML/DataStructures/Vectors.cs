...
namespace ILGPU_ML.DataStructures
{
    public struct Vec2i
    {
        ...
        public static Vec2i operator /(int v, Vec2i v1)
        {
            return new Vec2i(v / v1.x, v / v1.y);
        }

        public static Vec2i operator /(float v, Vec2i v1)
        {
            return new Vec2i(v / v1.x, v / v1.y);
        }


        public static Vec2i operator *(Vec2i v1, int v)
        {
            return new Vec2i(v1.x * v, v1.y * v);
        }

        public static Vec2i operator *(Vec2i v1, float v)
        {
            return new Vec2i(v1.x * v, v1.y * v);
        }
        ...
        public static implicit operator LongIndex2D(Vec2i d)
        {
            return new LongIndex2D(d.x, d.y);
        }

        public static implicit operator Index2D(Vec2i d)
        {
            return new Index2D(d.x, d.y);
        }

        public static implicit operator Vec2i(LongIndex2D d)
        {
            return new Vec2i(d.X, d.Y);
        }

        public static implicit operator Vec2i(Index2D d)
        {
            return new Vec2i(d.X, d.Y);
        }
    }
